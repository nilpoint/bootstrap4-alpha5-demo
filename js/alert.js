...
(
  function($){
    ...
    // Link the data-minimize the click event to the minimize function
    // Then Now, an element with the data-minimize attribute with an "alert" 
    // value will call the Alert.prototype.minimize function on a click event.
